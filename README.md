...
- Seven analysis intents are available: identify, explain, how-to, deep-dive, AI provenance/forensics, customer reply, and code analysis. Output can be adaptive, summary, steps, full report, customer-ready, or explicit Markdown.
