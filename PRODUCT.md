...
- Text/PDF/browser selections are automatically checked for signed provenance and configured official watermark-verifier results. Statistical writing-style detectors stay heuristic and cannot produce a verified-AI status; provider-specific text watermarks require the matching generation configuration/key and may weaken after substantial rewriting or translation.
