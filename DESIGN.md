...
- AI-origin, watermark, and prompt-recovery rows appear only for image and video evidence. Text, code, PDF text, and browser text selections never show an AI-authorship verdict or provenance badge.
