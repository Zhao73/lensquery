...
4. Install the LensQuery Native Messaging Host. On Windows development builds:
   ...
   ```
5. Start LensQuery, focus a normal web page, and press `Ctrl+Shift+Space`. Point to an element, click, then choose the text range and analysis intent in the compact in-page composer before sending.
